...
type FirebaseAction<Type: $Values<typeof actionTypes>, Payload = void> = Action<
  Type,
  Payload,
>;
type AuthChanged = FirebaseAction<typeof actionTypes.AUTH_CHANGED, ?User>;
type SetUserInformation = FirebaseAction<
  typeof actionTypes.SET_USER_INFO,
  ?UserInformation,
>;
export type ReducerAction = AuthChanged | SetUserInformation;

export const authChanged = (user: ?User): AuthChanged => ({
